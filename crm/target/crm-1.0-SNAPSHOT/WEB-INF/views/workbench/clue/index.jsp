...
<script type="text/javascript">
	...
	$(function(){
			...
			$.ajax({
				...
				success:function (data) {
					if (data.flag){
						alert("保存成功");
						//保存完成后清空模态窗口数据
						$("#createClueModalForForm")[0].reset();
						//关闭模态窗口
		...
		$("#clueBodys").on("click",$(".checkbox"),function () {
...
<%--							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='clueDetail';">李四先生</a></td>--%>
<%--							<td>动力节点</td>--%>
<%--							<td>010-84846003</td>--%>
<%--							<td>12345678901</td>--%>
<%--							<td>广告</td>--%>
